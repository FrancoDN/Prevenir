...
function llenardatos() {
    ...
    if (Contacto_estrecho === "Si" && sintomas >= 1) {
        Sospechoso = "Si";
        window.open('https://prevenir.net.ar/ensenada/resultados/positivo.html', "_self");
        ...
        Sospechoso = "No";
        window.open('https://prevenir.net.ar/ensenada/resultados/esen_noPositivo.html', "_self");
        ...
        Sospechoso = "No";
        window.open('https://prevenir.net.ar/ensenada/resultados/noPositivo.html', "_self");
